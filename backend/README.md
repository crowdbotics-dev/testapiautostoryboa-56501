...
## Project Structure
    ...
    ├── testapiautostoryboa_56501  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_56501`
...
2. Clone this repo and `cd testapiautostoryboa_56501`
